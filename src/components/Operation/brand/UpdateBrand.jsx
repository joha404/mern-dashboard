...
import { UpdateTheBrand } from "../../../../api/operations/brand";
import PrimaryButton from "../../../common/PrimaryButton";

function UpdateBrand({ item, onClose, refetchHeroContent }) {
  ...
  const handleUpdate = async () => {
    try {
      setIsLoading(true);
      await UpdateTheBrand({ title: formData.title }, item._id); // Send JSON
      refetchHeroContent();
  ...
  return (
    <div>
      ...
      >
        <h1 className="text-center text-2xl font-semibold">Update Brand</h1>
                ...
                <div className="flex items-start gap-4 mb-5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Your brand information has been successfully updated.
                    </p>
                  </div>
                </div>
