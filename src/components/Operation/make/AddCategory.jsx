...
import { AddNewCategory } from "../../../api/operations/category";
import PrimaryButton from "../../common/PrimaryButton";

function AddCategory({ onClose, refetchHeroContent }) {
        ...
        {previewUrl && (
          <div className="mt-4">
            <img
              src={previewUrl}
              alt="Preview"
              className="max-w-sm rounded border border-gray-200 shadow"
            />
          </div>
        )}
        <div>
