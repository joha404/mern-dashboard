...
import { UpdateTheCategory } from "../../../api/operations/category";
import PrimaryButton from "../../common/PrimaryButton";

function UpdateCategory({ item, onClose, refetchHeroContent }) {
        ...
        {previewUrl && (
          <div className="mt-4">
            <img
              src={previewUrl}
              alt="Preview"
              className="h-full w-full rounded border border-gray-200 shadow"
            />
          </div>
        )}
        <div>
          ...
          <input
            ...
            accept="image/*"
            onChange={handleChange}
            className="w-full p-2 border border-gray-300 bg-gray-50 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-dark text-gray-800"
          />
        </div>
